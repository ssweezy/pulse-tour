      ...
      <div className="tour-inner">
        ...
        <div className="tour-about-section">
          <div className="tour-about-text">
            Тур в Верхнюю Балкарию — это уникальная возможность познакомиться с
            красотами региона. Стоимость участия — 7500 рублей с человека.
            Путешествие позволит насладиться неповторимыми пейзажами и узнать
            больше о культуре и традициях места. Мы предлагаем тщательно
            спланированный маршрут, который раскроет все прелести Верхней
            Балкарии. Выберите удобные для вас дни и отправьтесь в незабываемое
            путешествие!
          </div>
        </div>
